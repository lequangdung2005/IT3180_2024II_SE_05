...
public class ApiMapping 
{
    ...
    public final static String CHECK_BANKING = "/check-banking";
    ...
    public final static String DELETE_OBJECT = "/api/delete-object";
    public final static String UPDATE_OBJECT = "/api/update-object";
